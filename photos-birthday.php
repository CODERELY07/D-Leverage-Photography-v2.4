<?php
    $title = "Photo Birthday Album | D'Leverage Photography";
...
<main>
    <div class="container">
        <h3 class="display-5 mb-5 text-center">Birthday</h3>
        <div class="album-container mt-5">
            <div class="album-flex">
                <?php
                    $query = "SELECT * FROM album WHERE album_category = 'birthday'";
    ...
    <h6>Check Also:</h6>
    <ul>
        <li><a href="photos-wedding.php" class="link">Wedding Photos</a></li>
