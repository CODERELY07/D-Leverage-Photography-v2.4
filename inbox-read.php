  ...
  <body>
        ...
        <main class="container py-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0">Read Messages</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-danger deleteMessage" data-id="<?php echo $row['id']; ?>">
                                                        Delete
                                                    </button>
                                                </div>
            ...
            document.querySelectorAll('.deleteMessage').forEach(function(btn){
                btn.addEventListener("click", function(e){
                    ...
                    if (confirm("Are you sure you want to delete this Message?")) {
                        ...
                        const data = `id=${encodeURIComponent(messageId)}`;
