<?php
    ...
    // Fetched once and reused for the count, the "add image" dropdown, and the table below
    $albums = [];
                                    ...
                                    <tr id="<?php echo (int) $row['id']; ?>" data-album-name="<?php echo strtolower($safeName); ?>">
                                        ...
                                        <td data-label="Actions">
                                            <div class="icon-btn-group">
                                                <a href="view.php?id=<?php echo (int) $row['id']; ?>" class="icon-btn icon-view" data-tooltip="View" aria-label="View album">
                                                ...
                                                <form action="delete_album.php" class="delete-form d-inline" method="POST">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="uploadAlbum.php" enctype="multipart/form-data" method="POST" id="albumForm">
